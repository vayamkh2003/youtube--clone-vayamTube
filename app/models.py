...
class UserProfile(models.Model):
    ...
    email = models.EmailField(unique=True, blank=True, null=True)  # Make email unique
    bio = models.TextField(blank=True, null=True)
    profile_picture = models.ImageField(upload_to='images/', default='images/default_user_pfp.png', blank=True, null=True)
...
class Channel(models.Model):
    ...
    name = models.CharField(max_length=100, db_index=True)  # Added index for search
...
class Video(models.Model):
    ...
    upload_time = models.DateTimeField(auto_now_add=True, db_index=True)  # Index for ordering
    title = models.CharField(max_length=100, db_index=True)  # Index for search
